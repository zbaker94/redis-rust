...
pub fn main(){
    ...
    let error_cases_deserialize: Vec<(&str, RedisDataType, &str)> = vec![
        ("+Hello World", RedisDataType::SimpleError("Invalid format".to_string()), "simple string no crlf at end"),
        ...
        ("-World", RedisDataType::SimpleError("Invalid format".to_string()), "simple error no crlf at end 1"),
        ("-World\r", RedisDataType::SimpleError("Invalid format".to_string()), "simple error no crlf at end 2"),
        ("-World\n", RedisDataType::SimpleError("Invalid format".to_string()), "simple error no crlf at end 3"),
        ...
        (":123", RedisDataType::SimpleError("Invalid format".to_string()), "integer no crlf at end 1"),
        (":123\r", RedisDataType::SimpleError("Invalid format".to_string()), "integer no crlf at end 2"),
        (":123\n", RedisDataType::SimpleError("Invalid format".to_string()), "integer no crlf at end 3"),
        ...
        ("$5\r\nHello", RedisDataType::SimpleError("Invalid format".to_string()), "bulk string no crlf at end 1"),
        ("$5\r\nHello\r", RedisDataType::SimpleError("Invalid format".to_string()), "bulk string no crlf at end 2"),
        ("$5\r\nHello\n", RedisDataType::SimpleError("Invalid format".to_string()), "bulk string no crlf at end 3"),
